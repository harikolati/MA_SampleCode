...
@NgModule({
  declarations: [
    AppComponent,
    SearchboxComponent, HeaderComponent, FooterComponent, MyDealsComponent, AllDealsComponent, MethodologyComponent, LearninganddevelopmentComponent, InitiativesComponent, QuickToolsComponent, AllToolsComponent
  ],
  imports: [
    BrowserModule,
